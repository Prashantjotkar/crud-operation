...
public class crudresource {
	...
	@Path("/retrieveById/{studentNo}")
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public ArrayList<crudmodel>  getUser(@PathParam("studentNo") int studentNo) throws SQLException {
		return service.getUserById(studentNo);
	...
	@DELETE
	@Consumes(MediaType.APPLICATION_JSON)
	public int deleteUser(@PathParam("id") int studentNo) {
		return service.deletetUser(studentNo);
